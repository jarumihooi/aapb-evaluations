...
'''
This utility is primarily used in evaluation code to download gold standard annotated data for use as a reference during
the evaluation of app models in CLAMS. 
Input: github commit url to download golds data from.
Output: Creates a temporary dir in local, downloads the files, and then returns name/str of that folder. 
'''
